      ...
      <main>
        ...
        <section>
          ...
          <div className="columns">
            <div>
              <h4>Wood</h4>
              <p>These are usually, but not always, fixed-axle. Decent cheap ones are still available, but you can also find fancier models with features like adjustable axles and interesting hardwoods.</p>
            </div>
            <div>
              <h4>Plastic</h4>
              <p>Plastic yoyos run the gamut from literally unusable dollar-store garbage to beautifully machined <a href="https://en.wikipedia.org/wiki/Polyoxymethylene">POM</a> (AKA "Delrin," which is a brand name) or polycarbonate that feel and play great and cost as much as a decent aluminum yoyo. On the other hand, you can also get a very good injection-molded yoyo that you'll use forever for $20 or less.</p>
            </div>
            <div>
              <h4>Aluminum</h4>
              <ul>
            ...
            <div>
              ...
              <p className="point">... That said, if you want a Ti anyway, one good way to go about it is to keep an eye out for preorder announcements. They're sometimes available used too, of course, but not necessarily much cheaper.</p>
            </div>
            <div>
              <h4>Steel</h4>
        ...
        <section>
          <h2>Getting started</h2>
            ...
            <p className="point">What I <em>don't</em> recommend is trying to learn the basics on a responsive aluminum yoyo. Some people do, but... ouch. Start out with a plastic one!</p>
            <h3>Options</h3>
              <div className="content">
                <div className="primary">
                  <ol className="list-decimal">
        ...
        <section>
          <h2>FAQs with somewhat controversial answers</h2>
            <div>
              ...
              <li>
                <p><b>Arguments in favor</b>: Reduced bearing noise, rust protection, theoretical increase in longevity.</p>
                <p className="point">Note that people living in some very humid and/or salty climates report that bearing lube isn't really optional for them.</p>
              </li>
              <li>
              ...
              <li>
                <p><b>My opinion</b>: Feel free to use thin lube, for obnoxiously noisy bearings at the very least. Use a pin or similar to apply a very small amount, ideally less than a drop. I've seen some instructions telling people to put in way too much. Too much does make the bearing semi-responsive, and then you'd need to clean it and start over.</p>
              </li>
              </ul>
            </div>
            <div>
              ...
              <div className="content">
                <div className="primary">
                  ...
                  <ul>
                    ...
                    <li>
                      <p><b>My opinion</b>: You should play with a responsive yoyo at least until you can throw straight, and then a few basic tricks until you get a feel for how you have to play to keep the yoyo from snapping back prematurely. And, from a purely practical standpoint, learning the very basic basics on a unresponsive yoyo would be pretty tedious&mdash;lots of winding the yoyo back up by hand, not so much practicing tricks.</p>
                    </li>
                  </ul>
                </div>
                <div className="box">
