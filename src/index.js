    ...
    {/* content */}
      ...
      <footer className="bg-secondaryone-verydark dark:bg-secondaryone-light dark:bg-opacity-70">
        <div className="footertext">
          <p>&copy;2021 Sarah Wilkes | <a className="text-primary-pale" href="https://mightycoyote.github.io/">Portfolio</a> | <a className="text-primary-pale" rel="me" href="https://nerdculture.de/@mightycoyote">Mastodon</a></p>
        </div>
      </footer>
    </div>
  );
