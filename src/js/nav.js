function Nav() {
    return (
        <nav className="py-4">
            <ul className="clear-both flex flex-col md:flex-row list-none place-items-center justify-center m-8 p-1 uppercase tracking-wider font-light text-sm no-underline border-t border-b border-secondaryone-verydark dark:border-secondaryone-pale">
